...
module main #(
 ...
 localparam p4 = v745ec5;
 localparam p11 = vf824a7;
 localparam p12 = v236d93;
 localparam p13 = v01d381;
 localparam p16 = v9d3abd;
 wire w0;
 wire w1;
 wire w2;
 wire w3;
...
module va1fbc9 #(
 ...
 localparam p2 = v5c678e;
 localparam p3 = v93035e;
 wire [0:31] w0;
 wire w1;
 wire [0:31] w4;
 wire w5;
...
//---------------------------------------------------
//-- Basic-Heart-Hz-32bits
//-- - - - - - - - - - - - - - - - - - - - - - - - --
//-- Basic-Heart-Hz-sys-32bits: periodic signal in Hertz. Duty cicle of 50 percent
//---------------------------------------------------
//---- Top entity
module vaaf5c4 (
 input v712289,
